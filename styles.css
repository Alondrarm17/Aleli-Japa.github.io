:root {
  ...
  --shadow-pink: 0 18px 40px rgba(255, 0, 200, 0.2);
  --radius: 24px;
  --max: 1180px;
}
...
body {
  ...
  color: var(--text);
  background: linear-gradient(180deg, #030303 0%, #070708 50%, #040404 100%);
  position: relative;
  overflow-x: hidden;
}
...
@media (max-width: 980px) {
  ...
  .reverse-mobile .feature-copy {
    order: 2;
  }

  .reverse-mobile .feature-image {
    order: 1;
  }
}
